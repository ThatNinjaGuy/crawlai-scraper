...
Each item yield by StreamedRunResult.stream()[](https://ai.pydantic.dev/results/<../api/result/#pydantic_ai.result.StreamedRunResult.stream>) is the complete text response, extended as new data is received.
