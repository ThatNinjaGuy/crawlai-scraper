...
# Crawl Results for: https://ai.pydantic.dev/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Introduction
...
@dataclass
class SupportDependencies: [](https://ai.pydantic.dev/<#__code_1_annotation_3>)
  customer_id: int
  db: DatabaseConn [](https://ai.pydantic.dev/<#__code_1_annotation_12>)

class SupportResult(BaseModel): [](https://ai.pydantic.dev/<#__code_1_annotation_13>)
...
# Crawl Results for: https://ai.pydantic.dev/agents/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/agents/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/agents/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Agents
## Introduction
...
@roulette_agent.tool
async def roulette_wheel(ctx: RunContext[int], square: int) -> str: [](https://ai.pydantic.dev/agents/<#__code_0_annotation_2>)
...
@agent.tool_plain(retries=5) [](https://ai.pydantic.dev/agents/<#__code_3_annotation_1>)
def infinite_retry_tool() -> int:
  raise ModelRetry('Please try again.')

try:
  result_sync = agent.run_sync(
    'Begin infinite retry loop!', usage_limits=UsageLimits(request_limit=3) [](https://ai.pydantic.dev/agents/<#__code_3_annotation_2>)
  )
except UsageLimitExceeded as e:
  print(e)
...
result2 = agent.run_sync(
  ...
  message_history=result1.new_messages(), [](https://ai.pydantic.dev/agents/<#__code_5_annotation_1>)
)
print(result2.data)
...
agent = Agent(
  'test',
  deps_type=User, [](https://ai.pydantic.dev/agents/<#__code_6_annotation_1>)
  result_type=bool,
)

@agent.system_prompt
def add_user_name(ctx: RunContext[str]) -> str: [](https://ai.pydantic.dev/agents/<#__code_6_annotation_2>)
...
foobar(result.data) [](https://ai.pydantic.dev/agents/<#__code_6_annotation_3>)
...
agent = Agent(
  'openai:gpt-4o',
  deps_type=str, [](https://ai.pydantic.dev/agents/<#__code_8_annotation_1>)
  system_prompt="Use the customer's name while replying to them.", [](https://ai.pydantic.dev/agents/<#__code_8_annotation_2>)
)

@agent.system_prompt [](https://ai.pydantic.dev/agents/<#__code_8_annotation_3>)
def add_the_users_name(ctx: RunContext[str]) -> str:
  return f"The user's name is {ctx.deps}."

@agent.system_prompt
def add_the_date() -> str: [](https://ai.pydantic.dev/agents/<#__code_8_annotation_4>)
...
@agent.tool_plain
def calc_volume(size: int) -> int: [](https://ai.pydantic.dev/agents/<#__code_10_annotation_1>)
  if size == 42:
    return size**3
  else:
    raise ModelRetry('Please try again.')

with capture_run_messages() as messages: [](https://ai.pydantic.dev/agents/<#__code_10_annotation_2>)
  try:
...
# Crawl Results for: https://ai.pydantic.dev/contributing/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/contributing/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/contributing/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Contributing
...
# Crawl Results for: https://ai.pydantic.dev/dependencies/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/dependencies/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/dependencies/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Dependencies
...
async def get_system_prompt(ctx: RunContext[MyDeps]) -> str: [](https://ai.pydantic.dev/dependencies/<#__code_1_annotation_2>)
...
@agent.system_prompt
def get_system_prompt(ctx: RunContext[MyDeps]) -> str: [](https://ai.pydantic.dev/dependencies/<#__code_2_annotation_2>)
...
class MyDeps:
  api_key: str
  http_client: httpx.AsyncClient
  async def system_prompt_factory(self) -> str: [](https://ai.pydantic.dev/dependencies/<#__code_4_annotation_1>)
...
async def application_code(prompt: str) -> str: [](https://ai.pydantic.dev/dependencies/<#__code_4_annotation_3>)
  ...
  ...
...
class TestMyDeps(MyDeps): [](https://ai.pydantic.dev/dependencies/<#__code_5_annotation_1>)
...
# Crawl Results for: https://ai.pydantic.dev/help/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/help/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/help/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Getting Help
...
# Crawl Results for: https://ai.pydantic.dev/install/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/install/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/install/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Installation
...
# Crawl Results for: https://ai.pydantic.dev/logfire/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/logfire/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/logfire/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Debugging and Monitoring
...
# Crawl Results for: https://ai.pydantic.dev/message-history/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/message-history/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/message-history/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Messages and chat history
...
# Crawl Results for: https://ai.pydantic.dev/models/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/models/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/models/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Models
...
# Crawl Results for: https://ai.pydantic.dev/multi-agent-applications/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/multi-agent-applications/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/multi-agent-applications/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Multi-agent Applications
...
joke_generation_agent = Agent('gemini-1.5-flash', result_type=list[str]) [](https://ai.pydantic.dev/multi-agent-applications/<#__code_0_annotation_2>)
...
@dataclass
class ClientAndKey: [](https://ai.pydantic.dev/multi-agent-applications/<#__code_1_annotation_1>)
  http_client: httpx.AsyncClient
  api_key: str
...
async def find_flight(usage: Usage) -> Union[FlightDetails, None]: [](https://ai.pydantic.dev/multi-agent-applications/<#__code_2_annotation_4>)
...
async def find_seat(usage: Usage) -> SeatPreference: [](https://ai.pydantic.dev/multi-agent-applications/<#__code_2_annotation_6>)
  message_history: Union[list[ModelMessage], None] = None
  while True:
...
async def main(): [](https://ai.pydantic.dev/multi-agent-applications/<#__code_2_annotation_7>)
  usage: Usage = Usage()
...
# Crawl Results for: https://ai.pydantic.dev/results/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/results/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/results/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Results
...
from pydantic_ai import Agent
agent = Agent('gemini-1.5-flash') [](https://ai.pydantic.dev/results/<#__code_4_annotation_1>)
...
async def main():
  async with agent.run_stream('Where does "hello world" come from?') as result: [](https://ai.pydantic.dev/results/<#__code_4_annotation_2>)
    async for message in result.stream(): [](https://ai.pydantic.dev/results/<#__code_4_annotation_3>)
      print(message)
      #> The first known
...
# Crawl Results for: https://ai.pydantic.dev/testing-evals/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/testing-evals/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/testing-evals/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Testing and Evals
...
from datetime import date
from pydantic_ai import Agent, RunContext
from fake_database import DatabaseConn [](https://ai.pydantic.dev/testing-evals/<#__code_0_annotation_1>)
from weather_service import WeatherService [](https://ai.pydantic.dev/testing-evals/<#__code_0_annotation_2>)
weather_agent = Agent(
  'openai:gpt-4o',
...
async def run_weather_forecast( [](https://ai.pydantic.dev/testing-evals/<#__code_0_annotation_3>)
...
def call_weather_forecast( [](https://ai.pydantic.dev/testing-evals/<#__code_2_annotation_1>)
...
class SqlSystemPrompt: [](https://ai.pydantic.dev/testing-evals/<#__code_4_annotation_1>)
  def __init__(
    ...
    self.db = db
  def build_prompt(self) -> str: [](https://ai.pydantic.dev/testing-evals/<#__code_4_annotation_2>)
    return f"""\
...
"""
  @staticmethod
  def format_example(example: dict[str, str]) -> str: [](https://ai.pydantic.dev/testing-evals/<#__code_4_annotation_3>)
    return f"""\
<example>
...
# Crawl Results for: https://ai.pydantic.dev/tools/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/tools/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/tools/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Function Tools
...
from pydantic_ai import Agent, RunContext
agent = Agent(
  'gemini-1.5-flash', [](https://ai.pydantic.dev/tools/<#__code_0_annotation_1>)
...
# Crawl Results for: https://ai.pydantic.dev/troubleshooting/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/troubleshooting/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/troubleshooting/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Troubleshooting
...
# Crawl Results for: https://ai.pydantic.dev/api/agent/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/agent/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/agent/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.agent`
###  Agent `dataclass`
...
run_stream(
  ...
  *,
  ...
  StreamedRunResult[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.StreamedRunResult> "pydantic_ai.result.StreamedRunResult")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps"), ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")]
]
...
run_stream(
  ...
  *,
  ...
  StreamedRunResult[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.StreamedRunResult> "pydantic_ai.result.StreamedRunResult")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps"), RunResultData[](https://ai.pydantic.dev/api/agent/<#pydantic_ai.agent.RunResultData> "pydantic_ai.agent.RunResultData")]
]
...
override(
  *,
  deps: AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps") | Unset = UNSET,
...
Name | Type | Description | Default  
---|---|---|---  
`deps` |  `AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps") | Unset` |  The dependencies to use instead of the dependencies passed to the agent run. |  `UNSET`  
...
```
system_prompt(
  func: Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[[RunContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.RunContext> "pydantic_ai.tools.RunContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")]], str[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/stdtypes.html#str>)]
) -> Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[[RunContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.RunContext> "pydantic_ai.tools.RunContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")]], str[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/stdtypes.html#str>)]
...
system_prompt(*, dynamic: bool[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/functions.html#bool>) = False) -> Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[
  [SystemPromptFunc[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.SystemPromptFunc> "pydantic_ai._system_prompt.SystemPromptFunc")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")]],
  SystemPromptFunc[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.SystemPromptFunc> "pydantic_ai._system_prompt.SystemPromptFunc")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")],
]
...
```
system_prompt(
  func: SystemPromptFunc[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.SystemPromptFunc> "pydantic_ai._system_prompt.SystemPromptFunc")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")] | None = None,
  /,
  *,
...
Name | Type | Description | Default  
---|---|---|---  
`func` |  `SystemPromptFunc[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.SystemPromptFunc> "pydantic_ai._system_prompt.SystemPromptFunc")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")] | None` |  The function to decorate |  `None`  
...
result_validator(
  func: Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[
    [RunContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.RunContext> "pydantic_ai.tools.RunContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")
  ]
) -> Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[
  [RunContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.RunContext> "pydantic_ai.tools.RunContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")
]
...
result_validator(
  func: Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[
    [RunContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.RunContext> "pydantic_ai.tools.RunContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")],
    Awaitable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/collections.abc.html#collections.abc.Awaitable> "collections.abc.Awaitable")[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")],
  ]
) -> Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[
  [RunContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.RunContext> "pydantic_ai.tools.RunContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")],
  Awaitable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/collections.abc.html#collections.abc.Awaitable> "collections.abc.Awaitable")[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")],
...
```
result_validator(
  func: Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")]
) -> Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")], ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")]
...
```
result_validator(
  func: Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")], Awaitable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/collections.abc.html#collections.abc.Awaitable> "collections.abc.Awaitable")[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")]]
) -> Callable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/typing.html#typing.Callable> "typing.Callable")[[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")], Awaitable[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/collections.abc.html#collections.abc.Awaitable> "collections.abc.Awaitable")[ResultData[](https://ai.pydantic.dev/api/agent/<../result/#pydantic_ai.result.ResultData> "pydantic_ai.result.ResultData")]]
...
```
tool(
  func: ToolFuncContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolFuncContext> "pydantic_ai.tools.ToolFuncContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps"), ToolParams[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolParams> "pydantic_ai.tools.ToolParams")]
) -> ToolFuncContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolFuncContext> "pydantic_ai.tools.ToolFuncContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps"), ToolParams[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolParams> "pydantic_ai.tools.ToolParams")]
...
tool(
  *,
  ...
  prepare: ToolPrepareFunc[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolPrepareFunc> "pydantic_ai.tools.ToolPrepareFunc")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps")] | None = None,
...
tool(
  func: (
    ToolFuncContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolFuncContext> "pydantic_ai.tools.ToolFuncContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps"), ToolParams[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolParams> "pydantic_ai.tools.ToolParams")] | None
  ) = None,
  /,
  *,
  retries: int[](https://ai.pydantic.dev/api/agent/<https:/docs.python.org/3/library/functions.html#int>) | None = None,
...
Name | Type | Description | Default  
---|---|---|---  
`func` |  `ToolFuncContext[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolFuncContext> "pydantic_ai.tools.ToolFuncContext")[AgentDeps[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.AgentDeps> "pydantic_ai.tools.AgentDeps"), ToolParams[](https://ai.pydantic.dev/api/agent/<../tools/#pydantic_ai.tools.ToolParams> "pydantic_ai.tools.ToolParams")] | None` |  The tool function to register. |  `None`  
...
# Crawl Results for: https://ai.pydantic.dev/api/exceptions/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/exceptions/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/exceptions/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.exceptions`
###  ModelRetry
...
# Crawl Results for: https://ai.pydantic.dev/api/format_as_xml/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/format_as_xml/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/format_as_xml/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.format_as_xml`
###  format_as_xml
```
format_as_xml(
...
# Crawl Results for: https://ai.pydantic.dev/api/messages/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/messages/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/messages/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.messages`
...
# Crawl Results for: https://ai.pydantic.dev/api/result/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/result/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/result/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.result`
...
# Crawl Results for: https://ai.pydantic.dev/api/settings/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/settings/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/settings/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.settings`
###  ModelSettings
...
# Crawl Results for: https://ai.pydantic.dev/api/tools/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/tools/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/tools/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.tools`
...
# Crawl Results for: https://ai.pydantic.dev/api/usage/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/usage/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/usage/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.usage`
###  Usage `dataclass`
...
# Crawl Results for: https://ai.pydantic.dev/api/models/anthropic/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/anthropic/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/anthropic/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.anthropic`
## Setup
...
# Crawl Results for: https://ai.pydantic.dev/api/models/base/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/base/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/base/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models`
...
# Crawl Results for: https://ai.pydantic.dev/api/models/function/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/function/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/function/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.function`
...
# Crawl Results for: https://ai.pydantic.dev/api/models/gemini/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/gemini/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/gemini/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.gemini`
...
# Crawl Results for: https://ai.pydantic.dev/api/models/groq/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/groq/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/groq/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.groq`
## Setup
...
# Crawl Results for: https://ai.pydantic.dev/api/models/mistral/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/mistral/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/mistral/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.mistral`
## Setup
...
# Crawl Results for: https://ai.pydantic.dev/api/models/ollama/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/ollama/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/ollama/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.ollama`
## Setup
...
ollama_model = OllamaModel(
  model_name='qwen2.5-coder:7b', [](https://ai.pydantic.dev/api/models/ollama/<#__code_2_annotation_1>)
  base_url='http://192.168.1.74:11434/v1', [](https://ai.pydantic.dev/api/models/ollama/<#__code_2_annotation_2>)
)
...
# Crawl Results for: https://ai.pydantic.dev/api/models/openai/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/openai/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/openai/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.openai`
## Setup
...
# Crawl Results for: https://ai.pydantic.dev/api/models/test/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/test/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/test/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.test`
...
# Crawl Results for: https://ai.pydantic.dev/api/models/vertexai/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/api/models/vertexai/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/api/models/vertexai/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# `pydantic_ai.models.vertexai`
...
# Crawl Results for: https://ai.pydantic.dev/examples/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Examples
...
# Crawl Results for: https://ai.pydantic.dev/examples/bank-support/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/bank-support/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/bank-support/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Bank support
...
# Crawl Results for: https://ai.pydantic.dev/examples/chat-app/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/chat-app/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/chat-app/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Chat App with FastAPI
...
# Crawl Results for: https://ai.pydantic.dev/examples/flight-booking/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/flight-booking/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/flight-booking/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Flight booking
...
# Crawl Results for: https://ai.pydantic.dev/examples/pydantic-model/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/pydantic-model/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/pydantic-model/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Pydantic Model
...
# Crawl Results for: https://ai.pydantic.dev/examples/rag/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/rag/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/rag/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# RAG
...
# Crawl Results for: https://ai.pydantic.dev/examples/sql-gen/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/sql-gen/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/sql-gen/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# SQL Generation
...
# Crawl Results for: https://ai.pydantic.dev/examples/stream-markdown/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/stream-markdown/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/stream-markdown/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Stream markdown
...
# Crawl Results for: https://ai.pydantic.dev/examples/stream-whales/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/stream-whales/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/stream-whales/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Stream whales
...
# Crawl Results for: https://ai.pydantic.dev/examples/weather-agent/
...
Version Notice
This documentation is ahead of the last release by [6 commits](https://ai.pydantic.dev/examples/weather-agent/<https:/github.com/pydantic/pydantic-ai/compare/v0.0.18...main>). You may see documentation for features not yet supported in the latest release [v0.0.18 2025-01-07](https://ai.pydantic.dev/examples/weather-agent/<https:/github.com/pydantic/pydantic-ai/releases/tag/v0.0.18>). 
# Weather agent
